...
const contactLinks = [
  {
    label: "Email",
    value: "v.londono.naranjo@gmail.com",
  ...
  },
  {
    label: "GitHub",
    value: "/Viviana9110",
    href: "https://github.com/Viviana9110",
    icon: (
      <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold mt-3 mb-4 leading-tight">
            ...
            <span className="text-purple-400">proyecto al siguiente nivel?</span>
          </h2>
          <p className="text-gray-400 mb-10 max-w-lg mx-auto">
            Cuéntame tu idea. Respondo en menos de 24 horas y te doy una
            primera orientación sin costo ni compromisos.
          </p>

          <a
            href="mailto:v.londono.naranjo@gmail.com"
            className="inline-block px-10 py-4 bg-purple-600 hover:bg-purple-500 rounded-full font-semibold text-lg transition-colors glow mb-12"
          >
            Escribirme ahora
          </a>

          <div className="border-t border-white/10 pt-10 flex flex-col sm:flex-row gap-6 justify-center items-center">
